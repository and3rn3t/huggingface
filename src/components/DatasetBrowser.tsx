...
import { MagnifyingGlass, Database, Copy, Sparkle, Heart } from '@phosphor-icons/react'
...
export function DatasetBrowser() {
  ...
  const favoriteDatasets = SAMPLE_DATASETS.filter(dataset => 
    isFavorite(dataset.id, 'dataset')
  )

  const displayDatasets = activeTab === 'favorites' ? favoriteDatasets : filteredDatasets
    ...
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value={activeTab} className="space-y-4 mt-6">
              ...
              >
                ...
                >
                  <Heart 
                    ...
                    className={isFavorite(dataset.id, 'dataset') ? 'text-accent' : 'text-muted-foreground'}
                  />
                </Button>
          ...
          {displayDatasets.length === 0 && activeTab === 'all' && (
          ...
          {displayDatasets.length === 0 && activeTab === 'favorites' && (
            <div className="text-center py-12">
              <Heart className="mx-auto mb-4 text-muted-foreground" size={48} />
              <h3 className="text-lg font-medium mb-2">No favorites yet</h3>
              <p className="text-muted-foreground">Click the heart icon on any dataset to save it to your favorites</p>
            </div>
          )}
        </TabsContent>
      </Tabs>
